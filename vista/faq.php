...
<html lang="en">
  <head>
    ...
    <link href="css/normalize.css" rel="stylesheet" type="text/css" /><link href="css/all.css" rel="stylesheet" type="text/css" />
    <link href="//cdnjs.cloudflare.com/ajax/libs/font-awesome/3.1.0/css/font-awesome.min.css" rel="stylesheet" type="text/css" />

    <script src="../controlador/modernizr.js" type="text/javascript"></script>
  ...
  <body class="faq">
    ...
    <div class="contain-to-grid">
      <nav class="top-bar" data-topbar>
        <ul class="title-area">
          <li class="name">
            <h1><a href="/sockets/index.html">Apache Friends</a></h1>
          </li>
        ...
        <section class="top-bar-section">
          ...
          <ul class="right">
              ...
              <li class=""><a href="howto.html">HOW-TO Guides</a></li>
...
<div class="row">
    ...
    <dl class="accordion">
      ...
      <p>You should see the XAMPP start page, as shown below.</p>
        <img src="images/xampp-windows-start.jpg" />
      </dd>
...
<a target="_blank" href="http://www.fastly.com/">                    CDN provided by
                    <img width="48" data-2x="images/fastly-logo@2x.png" src="images/fastly-logo.png" />
</a>                </li>
              </ul>
            </div>
    ...
    <script src="../controlador/all.js" type="text/javascript"></script>
  </body>
</html>
